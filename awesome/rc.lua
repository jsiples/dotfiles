...
theme_path = os.getenv("HOME").."/.config/awesome/themes/siples/theme.lua"
...
memorywidget_icon:set_image(beautiful.memory_icon)
...
cpuloadwidget_icon:set_image(beautiful.cpu_icon)
